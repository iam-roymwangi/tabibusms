<template>
  <div class="min-h-screen font-sans text-gray-900">
     <!-- Header  -->
    <header :class="`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-4' : 'bg-transparent py-4'}`">
      <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-4">
          <a href="#portal" class="px-4 py-2 text-primary border border-primary rounded-lg hover:bg-primary hover:text-white transition-colors">
            Login
          </a>
        </div>
              ...
              <div class="space-y-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <p class="text-sm text-gray-700">
                    "Hi John, your appointment with Dr. Smith is tomorrow at 2:00 PM. Reply CONFIRM to confirm. - Tabibu Health"
                  </p>
                </div>
      ...
      <section id="features" class="py-20 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center max-w-2xl mx-auto mb-12">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">SMS Features for Healthcare</h2>
            <p class="text-gray-600">
              Everything you need to communicate effectively with patients and healthcare providers.
            </p>
          </div>
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="relative">
              <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Appointment Reminders</h3>
                <p class="text-gray-600">Automated SMS reminders to reduce no-shows and improve patient attendance.</p>
              </div>
            </div>
            ...
            <div class="relative">
              <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Medication Alerts</h3>
                <p class="text-gray-600">Send timely medication reminders to help patients stay on track with their treatment.</p>
              </div>
            </div>
            ...
            <div class="relative">
              <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Custom Sender ID</h3>
                <p class="text-gray-600">Use your clinic or hospital name as the sender ID for professional messaging.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-white rounded-xl shadow-md p-6">
              ...
              <div class="bg-gray-900 rounded-lg p-4 text-sm text-green-400 font-mono">
                ...
                <div class="text-blue-300">const</div> sms = <div class="text-blue-300">require</div>(<div class="text-yellow-300">'tabibu-sms'</div>);
                <div class="mt-2">sms.send({</div>
                <div class="ml-4">to: <div class="text-yellow-300">'+254722123456'</div>,</div>
                <div class="ml-4">message: <div class="text-yellow-300">'Hello from Tabibu!'</div></div>
                <div>});</div>
              </div>
          ...
          <form @submit.prevent="submitPricingRequest" class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  v-model="pricingForm.organization" 
                  type="text" 
                  required 
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                >
            ...
            <div>
              ...
              <input 
                v-model="pricingForm.senderId" 
                type="text" 
                placeholder="e.g., TABIBU, CLINIC, HOSPITAL"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
              >
